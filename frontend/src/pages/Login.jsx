...
export default function Login() {
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-16" data-testid="login-page">
      ...
      <p className="text-white/70 mt-2">Log in to manage your collabs and campaigns.</p>

      <button onClick={handleGoogle} data-testid="google-login-btn" className="mt-8 w-full bg-[#13131B] border border-white/20 py-3 font-semibold hover:bg-white/10 hover:text-white transition-colors flex items-center justify-center gap-2">
      ...
      <p className="mt-6 text-sm text-white/70">New here? <Link to="/signup" className="text-[#9D7CFF] font-semibold">Create an account</Link></p>
    </div>
  );
}
