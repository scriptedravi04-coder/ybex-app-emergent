...
export default function Signup() {
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-16" data-testid="signup-page">
      ...
      <p className="text-[#525252] mt-2">Start collaborating with India&apos;s most transparent network.</p>

      <button onClick={handleGoogle} data-testid="google-signup-btn" className="mt-8 w-full bg-white border border-[#0A0A0A] py-3 font-semibold hover:bg-[#0A0A0A] hover:text-white transition-colors flex items-center justify-center gap-2">
      ...
      <p className="mt-6 text-sm text-[#525252]">Already have an account? <Link to="/login" className="text-[#E84A27] font-semibold">Log in</Link></p>
    </div>
  );
}
