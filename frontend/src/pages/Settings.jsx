...
export default function Settings() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 md:px-12 py-12" data-testid="settings-page">
      ...
      <div className="mt-6 bg-white border border-[#E5E5E5] rounded-2xl p-6">
        <h2 className="font-display text-2xl flex items-center gap-2"><SettingsIcon size={20}/> Profile</h2>
        <p className="text-sm text-[#525252] mt-2">{user?.role === "creator" ? "Edit your creator profile, rate card, languages." : user?.role === "brand" ? "Edit your brand details, logo, and industry." : "Complete onboarding to access more settings."}</p>
      ...
      <div className="mt-6 bg-white border border-[#E5E5E5] rounded-2xl p-6">
        ...
        <p className="text-sm text-[#525252] mt-2">Your data is private. Only verified brands can see your rate card and contact info.</p>
      </div>
...
const Row = ({ label, value }) => (
  <div className="flex justify-between border-b border-[#E5E5E5] pb-2 last:border-0">
